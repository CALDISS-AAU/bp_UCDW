...
model_a = Word2Vec(sentences=tokenized_corpus_all, vector_size=200, window=15, sg=1, min_count=5, workers=8)
model_m = Word2Vec(sentences=tokenized_corpus_male, vector_size=200, window=15, sg=1, min_count=5, workers=8)
model_f = Word2Vec(sentences=tokenized_corpus_female, vector_size=200, window=15, sg=1, min_count=5, workers=8)
